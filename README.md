...
- Encoder push: ROW3/COL3 = P1.13 / P0.31.
- 12 phím dùng matrix điện **3 ROW × 4 COL**, khớp trực tiếp layout vật lý 4 cột × 3 hàng.
- K1-K4 = ROW0/COL0-3, K5-K8 = ROW1/COL0-3, K9-K12 = ROW2/COL0-3.
...
- Ô trên màn lần lượt là keymap position 0–11 (trái sang phải, trên xuống dưới).
  Matrix điện cũng là **4 COL × 3 ROW**, khớp trực tiếp với layout 4 cột × 3 hàng.
  Position 12 là encoder push ở ROW3/COL3, không tạo ô thứ 13.
